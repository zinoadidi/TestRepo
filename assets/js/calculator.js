...
function Calculate(formObj)
        {
            ...
            if (emptyField(formObj.numyears))
                ...
                document.getElementById("annualamount").innerHTML = "₦"+numberWithCommas(round_decimals(initial_deposit + (monthly_deposit * 12 * num_years), 2)); 
                document.getElementById("result").innerHTML = "₦"+numberWithCommas(round_decimals(base, 2)); 
